...
function drawBox() {
  ...
  if (bWidth > cnv.width * 0.26) {
    ...
    text(eval(activeObj).title, tX, cnv.height/9, cnv.width * 0.19, cnv.width * 0.156);
    textWrap(WORD);
    text(eval(activeObj).des, tX, cnv.height/9 + cnv.width*0.016, cnv.width*0.16, cnv.width*0.156);
  }
}
