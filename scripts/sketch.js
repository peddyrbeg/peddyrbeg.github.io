...
function setup() {
  ...
  randomObj.size(cnv.width * 0.104, cnv.wdith * 0.021);
  butPos2 = [cnv.width/2 - randomObj.width/2, cnv.height * 0.7];
...
function drawBox() {
  ...
  if (bWidth > cnv.width * 0.26) {
    image(activeImg, boxX - boxWidth/2 + (cnv.width * 0.018),  cnv.height/9, activeImg.width/(cnv.width * 0.001), activeImg.height/(cnv.width*0.001));
    noFill();
    fill(255,255,255);
    rectMode(CORNER);
    textAlign(LEFT);
