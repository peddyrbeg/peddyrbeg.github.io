...
class Point {
	...
	display() {
		...
		if (dist(this.x, this.y, mouseX, mouseY) < diam && box == false) {
			...
			imageMode(CENTER);
			copy(activeImg, activeImg.width*cnv.width*0.0001, activeImg.height*cnv.width*0.00005, activeImg.width*cnv.width*0.0004, cnv.width*0.25, cnv.width*0.15-cnv.width*0.052, cnv.height*0.7-cnv.width*0.052, cnv.width*0.104, cnv.width*0.104);
